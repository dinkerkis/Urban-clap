  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.white }}>
      <View style={{ paddingTop: Math.max(insets.top, 18) + 8, paddingBottom: 14, alignItems: 'center', borderBottomWidth: 1, borderBottomColor: colors.mauveTone94_2, backgroundColor: colors.white }}>
        <Text selectable style={{ fontSize: fontSizes.size18, lineHeight: 24, fontWeight: '600', color: colors.mauveTone12_4 }}>Refer and Earn</Text>
      </View>
      ...
      >
        <View style={{ paddingHorizontal: 20, paddingTop: 22, paddingBottom: 16, gap: 18, backgroundColor: colors.blueTone97 }}>
          <View style={{ minHeight: 105, paddingRight: 88, gap: 8 }}>
            <Text selectable numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.84} style={{ fontSize: fontSizes.size19, lineHeight: 25, fontWeight: '700', color: colors.violetTone12_2 }}>Refer and get FREE services</Text>
        ...
        <View style={{ marginHorizontal: 20, marginTop: 16, padding: 22, gap: 21, borderRadius: 10, borderCurve: 'continuous', backgroundColor: colors.blueTone97_3 }}>
          <Text selectable style={{ fontSize: fontSizes.size20, lineHeight: 27, fontWeight: '700', color: colors.mauveTone12 }}>How it works?</Text>
          {STEPS.map((step, index) => (
            <View key={step} style={{ minHeight: 46, flexDirection: 'row', alignItems: 'flex-start', gap: 15 }}>
              <View style={{ width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: colors.blueTone93 }}>
                <Text style={{ fontSize: fontSizes.size15, fontWeight: '600', color: colors.mauveTone17_3 }}>{index + 1}</Text>
              </View>
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 26, gap: 8 }}>
          <Text selectable style={{ fontSize: fontSizes.size18, lineHeight: 24, fontWeight: '700', color: colors.violetTone12_2 }}>You are yet to earn any scratch cards</Text>
