    ...
    <View style={{ flex: 1, backgroundColor: colors.violetTone98_2 }}>
      ...
      >
        <View style={{ alignItems: 'center', gap: 10, paddingHorizontal: 22 }}>
          ...
          <Text selectable style={{ paddingTop: 5, fontSize: fontSizes.size19, lineHeight: 25, fontFamily: fontFamilies.semiBold, color: colors.violetTone13 }}>No bookings yet</Text>
          ...
          >
            <Text style={{ fontSize: fontSizes.size13, fontFamily: fontFamilies.semiBold, color: colors.white }}>Explore services</Text>
          </Pressable>
        </View>
      </ScrollView>
    </View>
